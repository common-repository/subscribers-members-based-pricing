...
class ReactivateAction {
	...
	const ACTION = 'mbp_reactivate_global_rule';
	...
	public function getName() {
		return __( 'Reactivate', 'subscribers-members-based-pricing' );
	}
			...
			if ( $ruleId ) {
				...
				if ( false !== get_post_status( $ruleId ) ) {
					...
					try {
						...
						$this->getContainer()->getAdminNotifier()->flash( __( 'The rule reactivated successfully.',
